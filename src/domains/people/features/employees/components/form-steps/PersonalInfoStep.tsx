...
import type { EmployeeFormInput, PersonalInfoFormInput } from '../../schemas';
...
export const PersonalInfoStep: FC<PersonalInfoStepProps> = ({ initialData, onNext, onCancel }) => {
  ...
  const onSubmit = (data: PersonalInfoFormInput) => {
    onNext(data);
  };
  ...
  return (
    <Form layout="vertical" onFinish={handleSubmit(onSubmit)}>
      ...
      <Text type="secondary">
        กรุณากรอกข้อมูลพนักงานให้ครบถ้วน (รหัสพนักงานจะถูกสร้างอัตโนมัติ)
      </Text>
      ...
      <Row gutter={16}>
        ...
        <Col xs={24} md={8}>
          ...
          >
            <Controller name="nickname" control={control} render={({ field }) => <Input {...field} placeholder="John" />} />
          </Form.Item>
        </Col>
      </Row>
      ...
      <Row gutter={16}>
        <Col xs={24} md={12}>
          ...
          >
            <Controller name="thaiFirstName" control={control} render={({ field }) => <Input {...field} placeholder="จอห์น" />} />
          </Form.Item>
        </Col>
        <Col xs={24} md={12}>
          <Form.Item
          ...
          >
            <Controller name="thaiLastName" control={control} render={({ field }) => <Input {...field} placeholder="โด" />} />
          </Form.Item>
        </Col>
      </Row>
        ...
        <Col xs={24} md={8}>
          ...
          >
            <Controller
              name="email"
              control={control}
              render={({ field }) => <Input {...field} type="email" placeholder="john@company.com" />}
            />
          </Form.Item>
        </Col>
        <Col xs={24} md={8}>
      ...
      <Row gutter={16}>
        ...
        <Col xs={24} md={6}>
          <Form.Item label="เพศ" required validateStatus={errors.gender ? 'error' : ''} help={errors.gender?.message}>
            <Controller
              name="gender"
              control={control}
              render={({ field }) => (
        ...
        <Col xs={24} md={6}>
          ...
          >
            <Controller name="nationality" control={control} render={({ field }) => <Input {...field} placeholder="ไทย" />} />
          </Form.Item>
        </Col>
      </Row>
      ...
      <Row gutter={16}>
        ...
        <Col xs={24} md={12}>
          <Form.Item label="ศาสนา" validateStatus={errors.religion ? 'error' : ''} help={errors.religion?.message}>
            <Controller name="religion" control={control} render={({ field }) => <Input {...field} placeholder="พุทธ" />} />
          </Form.Item>
        </Col>
      </Row>
